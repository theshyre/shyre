# Expense receipt + email ingestion — design doc

> **Status:** planned, not yet started. Captures the converged design +
> open decisions from the 2026-04-29 five-persona review
> (solo-consultant, bookkeeper, agency-owner, security-reviewer,
> platform-architect). When implementation starts, this doc is the
> source of truth — it is the briefing for whoever picks the work up,
> not a sketch.
>
...
Forward a receipt email, drop a receipt PDF/image, or snap a
