...
- Click any customer name to open the detail page. Edit in place.
- **Archive** hides the customer from the list but preserves every historical invoice and entry. Archived customers can be unarchived from the detail page.
